---
WHAT: "Screenshot index for Native Obsidian - editor and reading view."
record_type: surface
surface_type: native
surface_id: native-editor-reading-view
aliases: ["Native Obsidian - editor and reading view"]
obsidian_surface_id: "editor-reading-view"
...
# Native Obsidian - editor and reading view

> [!summary]
> The core note surface in editing and reading modes.
...
#### editor reading view 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-editor-reading-view-2026-06-29.png]]

## How

1. Open a safe markdown note, show the title, body, and current mode controls, then capture either Live Preview or Reading view without plugin overlays.
