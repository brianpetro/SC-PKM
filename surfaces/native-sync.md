---
WHAT: "Screenshot index for Native Obsidian - sync."
record_type: surface
surface_type: native
surface_id: native-sync
aliases: ["Native Obsidian - sync"]
obsidian_surface_id: "sync"
...
# Native Obsidian - sync

> [!summary]
> Obsidian Sync status and settings.
...
![[assets/native-obsidian-surfaces-2026-06-29/native-sync-2026-06-29.png]]

## How

1. Show only non-sensitive sync health indicators; avoid account email, device names, remote vault names, and subscription details.
