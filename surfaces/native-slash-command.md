---
WHAT: "Screenshot index for Native Obsidian - slash command."
record_type: surface
surface_type: native
surface_id: native-slash-command
aliases: ["Native Obsidian - slash command"]
obsidian_surface_id: "slash-command"
...
#### slash command 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-slash-command-2026-06-29.png]]

## How

1. Enable slash commands if needed, click inside a fixture note, type slash, and show the menu with safe options before choosing one.
