---
WHAT: "Screenshot index for Native Obsidian - quick switcher."
record_type: surface
surface_type: native
surface_id: native-quick-switcher
aliases: ["Native Obsidian - quick switcher"]
obsidian_surface_id: "switcher"
...
# Native Obsidian - quick switcher

> [!summary]
> The modal for jumping to notes by title.
...
#### quick switcher 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-quick-switcher-2026-06-29.png]]

## How

1. Open Quick switcher, type a safe partial title, show the modal results, and do not select a private note.
