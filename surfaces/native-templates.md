---
WHAT: "Screenshot index for Native Obsidian - templates."
record_type: surface
surface_type: native
surface_id: native-templates
aliases: ["Native Obsidian - templates"]
obsidian_surface_id: "templates"
...
# Native Obsidian - templates

> [!summary]
> The native template insertion surface.
...
#### templates 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-templates-2026-06-29.png]]

## How

1. Open a fixture note, invoke Insert template, show the template picker or inserted safe template block, and keep the target note visible.
