---
WHAT: "Screenshot index for Native Obsidian - community plugins."
record_type: surface
surface_type: native
surface_id: native-community-plugins
aliases: ["Native Obsidian - community plugins"]
obsidian_surface_id: "community-plugins"
...
# Native Obsidian - community plugins

> [!summary]
> Community Plugins installed list and browser.
...
#### community plugins 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-community-plugins-2026-06-29.png]]

## How

1. Open Community plugins, show installed or search results with safe plugin names, and avoid account details or unrelated private plugin metadata when publishing externally.
