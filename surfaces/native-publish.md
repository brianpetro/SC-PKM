---
WHAT: "Screenshot index for Native Obsidian - publish."
record_type: surface
surface_type: native
surface_id: native-publish
aliases: ["Native Obsidian - publish"]
obsidian_surface_id: "publish"
...
# Native Obsidian - publish

> [!summary]
> Obsidian Publish configuration and publish queue.
...
![[assets/native-obsidian-surfaces-2026-06-29/native-publish-2026-06-29.png]]

## How

1. Do not open or change live publishing state without approval; use a fixture/demo account state or capture only public documentation surfaces.
