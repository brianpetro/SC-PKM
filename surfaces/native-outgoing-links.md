---
WHAT: "Screenshot index for Native Obsidian - outgoing links."
record_type: surface
surface_type: native
surface_id: native-outgoing-links
aliases: ["Native Obsidian - outgoing links"]
obsidian_surface_id: "outgoing-link"
...
# Native Obsidian - outgoing links

> [!summary]
> Outgoing links and unresolved links for the active note.
...
#### outgoing links 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-outgoing-links-2026-06-29.png]]

## How

1. Open the Outgoing Links pane beside a fixture note, show resolved and unresolved link sections when useful, and keep the active note identity visible.
