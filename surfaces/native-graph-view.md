---
WHAT: "Screenshot index for Native Obsidian - graph view."
record_type: surface
surface_type: native
surface_id: native-graph-view
aliases: ["Native Obsidian - graph view"]
obsidian_surface_id: "graph"
...
> [!summary]
> The native link graph, distinct from Smart Graph.
...
#### graph view 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-graph-view-2026-06-29.png]]

## How

1. Open native Graph view, show local or global graph controls, include enough UI identity to distinguish it from Smart Graph, and avoid private node labels.
