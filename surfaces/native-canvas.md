---
WHAT: "Screenshot index for Native Obsidian - canvas."
record_type: surface
surface_type: native
surface_id: native-canvas
aliases: ["Native Obsidian - canvas"]
obsidian_surface_id: "canvas"
...
> [!summary]
> The native Canvas board surface.
...
![[assets/native-obsidian-surfaces-2026-06-29/native-canvas-2026-06-29.png]]

## How

1. Open a safe Canvas file, show cards, links, and canvas controls, and keep text readable without exposing private planning boards.
