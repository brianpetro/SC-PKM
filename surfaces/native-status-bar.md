---
WHAT: "Screenshot index for Native Obsidian - status bar."
record_type: surface
surface_type: native
surface_id: native-status-bar
aliases: ["Native Obsidian - status bar"]
obsidian_surface_id: "editor-status"
...
# Native Obsidian - status bar

> [!summary]
> Status bar indicators such as words, characters, sync, and plugin status.
...
#### status bar 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-status-bar-2026-06-29.png]]

## How

1. Open a safe note, frame the bottom status bar with relevant indicators readable, and avoid account or sync details if sensitive.
