---
WHAT: "Screenshot index for Native Obsidian - settings."
record_type: surface
surface_type: native
surface_id: native-settings
aliases: ["Native Obsidian - settings"]
obsidian_surface_id: "settings"
...
> [!summary]
> The main Settings surface and navigation.
...
![[assets/native-obsidian-surfaces-2026-06-29/native-settings-2026-06-29.png]]

## How

1. Open Settings to a non-sensitive section, show the left settings nav and selected pane, and avoid account, license, sync, or API-key sections.
