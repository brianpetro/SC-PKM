---
WHAT: "Screenshot index for Native Obsidian - workspaces."
record_type: surface
surface_type: native
surface_id: native-workspaces
aliases: ["Native Obsidian - workspaces"]
obsidian_surface_id: "workspaces"
...
# Native Obsidian - workspaces

> [!summary]
> Workspace layout save/load surface.
...
#### workspaces 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-workspaces-2026-06-29.png]]

## How

1. Open Workspaces, show safe workspace names and layout controls, and avoid personal workspace names if sensitive.
