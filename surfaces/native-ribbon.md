---
WHAT: "Screenshot index for Native Obsidian - ribbon."
record_type: surface
surface_type: native
surface_id: native-ribbon
aliases: ["Native Obsidian - ribbon"]
obsidian_surface_id: "ribbon"
...
# Native Obsidian - ribbon

> [!summary]
> The left ribbon command surface.
...
![[assets/native-obsidian-surfaces-2026-06-29/native-ribbon-2026-06-29.png]]

## How

1. Frame the left ribbon beside a safe note, show recognizable command icons, and include a tooltip only if the surface being documented is that exact action.
