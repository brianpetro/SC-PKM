---
WHAT: "Screenshot index for Native Obsidian - daily notes."
record_type: surface
surface_type: native
surface_id: native-daily-notes
aliases: ["Native Obsidian - daily notes"]
obsidian_surface_id: "daily-notes"
...
# Native Obsidian - daily notes

> [!summary]
> Daily note creation and current daily note view.
...
![[assets/native-obsidian-surfaces-2026-06-29/native-daily-notes-2026-06-29.png]]

## How

1. Open or create a fixture-safe daily note, show the date title and template body, and avoid real journal content.
