---
WHAT: "Screenshot index for Native Obsidian - footnotes."
record_type: surface
surface_type: native
surface_id: native-footnotes
aliases: ["Native Obsidian - footnotes"]
obsidian_surface_id: "footnotes"
...
# Native Obsidian - footnotes

> [!summary]
> Footnote rendering and navigation in markdown notes.
...
#### footnotes 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-footnotes-2026-06-29.png]]

## How

1. Enable Footnotes if needed, open a fixture note with safe footnotes, show the note body and rendered footnote section or hover behavior.
