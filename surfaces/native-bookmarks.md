---
WHAT: "Screenshot index for Native Obsidian - bookmarks."
record_type: surface
surface_type: native
surface_id: native-bookmarks
aliases: ["Native Obsidian - bookmarks"]
obsidian_surface_id: "bookmarks"
...
# Native Obsidian - bookmarks

> [!summary]
> Saved files, headings, searches, and groups.
...
#### bookmarks 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-bookmarks-2026-06-29.png]]

## How

1. Open Bookmarks, use a safe fixture bookmark group, show several bookmark types, and keep private folders collapsed.
