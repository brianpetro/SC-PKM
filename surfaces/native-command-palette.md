---
WHAT: "Screenshot index for Native Obsidian - command palette."
record_type: surface
surface_type: native
surface_id: native-command-palette
aliases: ["Native Obsidian - command palette"]
obsidian_surface_id: "command-palette"
...
# Native Obsidian - command palette

> [!summary]
> The command palette modal and command search.
...
#### command palette 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-command-palette-2026-06-29.png]]

## How

1. Open Command palette, type a safe command fragment, show matching commands, and avoid executing the command during still capture.
