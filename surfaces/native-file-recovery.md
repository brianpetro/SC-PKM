---
WHAT: "Screenshot index for Native Obsidian - file recovery."
record_type: surface
surface_type: native
surface_id: native-file-recovery
aliases: ["Native Obsidian - file recovery"]
obsidian_surface_id: "file-recovery"
...
# Native Obsidian - file recovery

> [!summary]
> Snapshots and recovery interface.
...
#### file recovery 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-file-recovery-2026-06-29.png]]

## How

1. Open File recovery with a disposable fixture note, show snapshot list controls, and avoid private recovered text.
