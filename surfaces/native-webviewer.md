---
WHAT: "Screenshot index for Native Obsidian - web viewer."
record_type: surface
surface_type: native
surface_id: native-webviewer
aliases: ["Native Obsidian - web viewer"]
obsidian_surface_id: "webviewer"
...
# Native Obsidian - web viewer

> [!summary]
> Embedded web viewer surface.
...
#### webviewer 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-webviewer-2026-06-29.png]]

## How

1. Enable only in a fixture profile, open a safe public page or local documentation, and avoid authenticated websites.
