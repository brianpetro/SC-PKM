---
WHAT: "Screenshot index for Native Obsidian - file explorer."
record_type: surface
surface_type: native
surface_id: native-file-explorer
aliases: ["Native Obsidian - file explorer"]
obsidian_surface_id: "file-explorer"
...
> [!summary]
> The left-sidebar file tree for vault navigation.
...
#### file explorer 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-file-explorer-2026-06-29.png]]

## How

1. Open the File explorer pane, expand a safe fixture folder, show note and folder icons, and keep private folders collapsed.
