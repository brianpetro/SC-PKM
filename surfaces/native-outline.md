---
WHAT: "Screenshot index for Native Obsidian - outline."
record_type: surface
surface_type: native
surface_id: native-outline
aliases: ["Native Obsidian - outline"]
obsidian_surface_id: "outline"
...
# Native Obsidian - outline

> [!summary]
> The heading outline for the active note.
...
![[assets/native-obsidian-surfaces-2026-06-29/native-outline-2026-06-29.png]]

## How

1. Open a fixture note with multiple headings, open Outline in the sidebar, and show the active heading structure beside the note.
