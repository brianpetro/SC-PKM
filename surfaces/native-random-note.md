---
WHAT: "Screenshot index for Native Obsidian - random note."
record_type: surface
surface_type: native
surface_id: native-random-note
aliases: ["Native Obsidian - random note"]
obsidian_surface_id: "random-note"
...
# Native Obsidian - random note

> [!summary]
> Random note command and resulting active note.
...
#### random note 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-random-note-2026-06-29.png]]

## How

1. Use a fixture folder or safe vault state, invoke Random note, show the command/resulting note, and verify no private note was opened before capture.
