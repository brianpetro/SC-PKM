---
WHAT: "Screenshot index for Native Obsidian - properties."
record_type: surface
surface_type: native
surface_id: native-properties
aliases: ["Native Obsidian - properties"]
obsidian_surface_id: "properties"
...
# Native Obsidian - properties

> [!summary]
> The native Properties surface for note metadata.
...
#### properties 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-properties-2026-06-29.png]]

## How

1. Enable Properties if needed, open a fixture note with safe frontmatter, show property names and values without personal metadata.
