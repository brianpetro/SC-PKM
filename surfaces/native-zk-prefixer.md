---
WHAT: "Screenshot index for Native Obsidian - unique note creator."
record_type: surface
surface_type: native
surface_id: native-zk-prefixer
aliases: ["Native Obsidian - unique note creator"]
obsidian_surface_id: "zk-prefixer"
...
# Native Obsidian - unique note creator

> [!summary]
> Unique note creation with timestamp/prefix.
...
#### zk prefixer 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-zk-prefixer-2026-06-29.png]]

## How

1. Open the unique note creator command or resulting safe fixture note, show the generated filename pattern, and avoid creating clutter in the working vault.
