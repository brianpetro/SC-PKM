---
WHAT: "Screenshot index for Native Obsidian - backlinks."
record_type: surface
surface_type: native
surface_id: native-backlinks
aliases: ["Native Obsidian - backlinks"]
obsidian_surface_id: "backlink"
...
# Native Obsidian - backlinks

> [!summary]
> Incoming links for the active note.
...
#### backlinks 2026 06 29

![[assets/native-obsidian-surfaces-2026-06-29/native-backlinks-2026-06-29.png]]

## How

1. Open Backlinks for a fixture note with safe incoming links, show linked mentions and unlinked mentions if relevant, and keep the active note title visible.
