...
- Choose tools that feel frictionless ([[reference/Capture Tools]])
- Use naming and folder systems that make sense to *you*
- Regularly adapt based on what’s working (see [[reference/PKM/Advanced/Habitual Reflection]])

### 🧩 Related Notes
- [[reference/Centralized Repository]]
- [[reference/Creating Output]]
- [[reference/PKM/Advanced/Personal PKM Setups]]
