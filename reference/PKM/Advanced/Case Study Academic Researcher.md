...
### 🛠️ Workflow Snapshot
1. **Capture references** from Zotero or web to [[reference/Capture Tools]]
2. **Summarize papers** into atomic notes linked to a `topic/` folder
3. **Build a Zettelkasten** of insights using [[reference/PKM/Advanced/Zettelkasten Method]]
4. **Use tags and links** to group insights across fields ([[reference/PKM/Advanced/Networked Thought]])
5. **Draft papers** by querying vault for clusters using GPT

### 🔗 Notes That Support This Flow
- [[reference/PKM/Advanced/PKM in Research]]
- [[Efficient Retrieval]]
- [[Knowledge Synthesis]]
