---
WHAT: "Map of content for students: coursework capture, understanding, retention,"
aliases:
- Student PKM
- Study PKM
tags:
...
> [!summary]
> Map of content for students: coursework capture, understanding, retention, and exam prep.

> [!When to use]
> If class notes pile up and exam prep feels reactive, this map shows what to capture, how to review, and how to retain, even with tight deadlines.
...
- High volume of inputs (lectures, readings, assignments).
- Short feedback loops (quizzes, exams).
- Context switching across courses.

### Capture and processing workflow (lecture -> atomic concepts)
- 1 worked example note,
- 1 definition note,
- 1 "common misconception" note.
...
- One MOC per course: lectures, assignments, exams, key concepts.
- One note per assignment: requirements, outline, sources, draft.
