---
WHAT: "Embed and track chat threads inside notes so work stays anchored and loops get closed."
aliases: [Smart Chat plugin, Chat]
tags: [smart-tools, moc]
---

> [!summary]
> Smart Chat keeps AI threads anchored to the note they reference, so you can resume work later and close loops on purpose.

> [!tip] When to use
> Use this when you want AI help that stays attached to a project, meeting, decision, or draft.

## Docs

- Overview and comparison (codeblocks vs workspace): [Smart Chat](https://smartconnections.app/smart-chat/).
